    ...
    >
      <View style={styles.top}>
        ...
        <View style={styles.topRight}>
          <Text style={styles.amount}>{fmtAmt(invoice.grandTotal, sym)}</Text>
      ...
      <View style={styles.bottom}>
        ...
        <View style={styles.actions}>
          <TouchableOpacity onPress={onDuplicate} style={styles.iconBtn} hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}>

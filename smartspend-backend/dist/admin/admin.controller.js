...
let AdminController = class AdminController {
    constructor(adminService, mailService) {
    ...
    async sendTestEmail(user, body) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Failed to send test email: ${error.message || 'Check SMTP configuration'}`);
        }
    }
};
...
__decorate([
    (0, common_1.Delete)('users/:id/hard'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Permanently delete user and ALL their data (irreversible)' }),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Admin change user password and revoke all sessions' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Generate a short-lived token to log in as this user (15 min)' }),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),

...
class ResendOtpDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String }, purpose: { required: true, type: () => String, enum: ['email_verify', 'password_reset'] } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsIn)(['email_verify', 'password_reset']),
    __metadata("design:type", String)

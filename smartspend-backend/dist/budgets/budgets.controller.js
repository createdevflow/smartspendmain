...
let BudgetsController = class BudgetsController {
    ...
    findAll(user) { return this.budgetsService.findAll(user.sub); }
    create(user, dto) { return this.budgetsService.create(user.sub, dto); }
    findOne(user, id) { return this.budgetsService.findOne(user.sub, id); }
    progress(user, id) { return this.budgetsService.getProgress(user.sub, id); }
    update(user, id, dto) { return this.budgetsService.update(user.sub, id, dto); }
    remove(user, id) { return this.budgetsService.remove(user.sub, id); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], BudgetsController.prototype, "progress", null);
__decorate([
    (0, common_1.Patch)(':id'),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
